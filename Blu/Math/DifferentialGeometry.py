...
def laplacianLegacy(field: torch.Tensor,
                    delta: float) -> torch.Tensor:
    """
    Compute the Laplacian of the field using a fourth-order central difference.
    ...
    laplace: torch.Tensor = (-1 * torch.roll(field,
                                             shifts=2,
                                             dims=0)
                             + 16 * torch.roll(field,
                                               shifts=1,
